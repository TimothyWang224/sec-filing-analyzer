...
from src.sec_filing_analyzer.utils.etl_logging import setup_etl_logging, generate_run_id
...
def parse_args():
    ...
    # Company selection
    parser.add_argument("--tickers", type=str, nargs="+", default=["AAPL", "MSFT", "NVDA"],
                        help="Ticker symbols to process")

    # Filing types
    parser.add_argument("--filing-types", type=str, nargs="+", default=["8-K"],
                        help="Filing types to process")

    # Date range
    parser.add_argument("--days", type=int, default=30,
                        help="Number of days to look back for filings")
    parser.add_argument("--start-date", type=str,
                        help="Start date for filings (YYYY-MM-DD)")
    parser.add_argument("--end-date", type=str,
                        help="End date for filings (YYYY-MM-DD)")
    ...
    parser.add_argument("--rate-limit", type=float, default=0.5,
                        help="Initial rate limit in seconds")
    ...
    parser.add_argument("--semantic-only", action="store_true",
                        help="Only process semantic data")
