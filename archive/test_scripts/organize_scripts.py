"""
Organize scripts into a more robust directory structure.

This script:
1. Creates a new directory structure for scripts
2. Moves scripts to their appropriate directories
...
- `check_edgar_package.py`: Check Edgar package
...
This directory contains test scripts for the SEC Filing Analyzer project.

## Available Scripts

- `test_vector_store.py`: Test vector store
- `test_improved_xbrl.py`: Test improved XBRL
- `test_improved_xbrl_extractor.py`: Test improved XBRL extractor
- `test_edgar_library.py`: Test Edgar library
...
- `test_improved_edgar_extractor.py`: Test improved Edgar extractor
- `test_optimized_vector_store.py`: Test optimized vector store
- `test_parallel_xbrl.py`: Test parallel XBRL
- `test_reorganized_pipeline.py`: Test reorganized pipeline
- `test_reorganized_structure.py`: Test reorganized structure
- `test_simplified_xbrl.py`: Test simplified XBRL
- `test_specific_filing.py`: Test specific filing
- `test_with_mock_data.py`: Test with mock data
- `test_with_simplified_schema.py`: Test with simplified schema
