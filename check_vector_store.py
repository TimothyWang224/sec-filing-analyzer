...
aapl_filings = vector_store.search_vectors("AAPL", metadata_filter={"ticker": "AAPL"}, top_k=10)
...
msft_filings = vector_store.search_vectors("MSFT", metadata_filter={"ticker": "MSFT"}, top_k=10)
...
nvda_filings = vector_store.search_vectors("NVDA", metadata_filter={"ticker": "NVDA"}, top_k=10)
