...
def main():
    ...
    try:
        ...
        logger.info(f"Vector store: Found {results['vector_store']['found']}, Added {results['vector_store']['added']}, Updated {results['vector_store']['updated']}, Errors {results['vector_store']['errors']}")
        logger.info(f"File system: Found {results['file_system']['found']}, Added {results['file_system']['added']}, Updated {results['file_system']['updated']}, Errors {results['file_system']['errors']}")
        logger.info(f"Filing paths: Updated {path_results['updated']}, Not found {path_results['not_found']}, Errors {path_results['errors']}")
