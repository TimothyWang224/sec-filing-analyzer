...
def test_optimized_duckdb_store(financial_data):
    ...
    if len(financial_data.keys()) > 1:
        ...
        comparison_df = store.compare_companies(
            tickers=tickers,
            metric="revenue"
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--accessions", type=str, nargs="+", default=["0000320193-23-000077", "0000789019-23-001517"], help="SEC accession numbers")
