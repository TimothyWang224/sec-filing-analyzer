...
def show_company_metrics(financial_store: FinancialDataStore, ticker: str,
...
def compare_companies(financial_store: FinancialDataStore, tickers: List[str],
                     metric: str, start_year: Optional[int] = None,
                     end_year: Optional[int] = None,
                     quarterly: bool = False) -> None:
    """Compare companies.
...
def show_financial_ratios(financial_store: FinancialDataStore, ticker: str,
...
def show_filing_info(financial_store: FinancialDataStore, ticker: Optional[str] = None,
