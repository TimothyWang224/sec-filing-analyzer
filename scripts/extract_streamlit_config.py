...
try:
    ...
    config["streamlit"] = {
        ...
        "theme": {
            "base": streamlit_config.get("theme", {}).get("base", "light")
        },
        "ui": {
            "hide_top_bar": streamlit_config.get("ui", {}).get("hideTopBar", False)
        },
        "client": {
        ...
        "global": {
            ...
            "show_warning_on_direct_execution": streamlit_config.get("global", {}).get("showWarningOnDirectExecution", True),
            "data_frame_serialization": streamlit_config.get("global", {}).get("dataFrameSerialization", "arrow"),
            "suppress_deprecation_warnings": streamlit_config.get("global", {}).get("suppressDeprecationWarnings", True)
        }
    }
