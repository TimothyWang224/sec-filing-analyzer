...
def main():
    ...
    parser.add_argument("--accession_number", type=str,
                        help="Filing accession number (required for filing_sections)")
    parser.add_argument("--filing_types", type=str, nargs="*",
                        help="List of filing types to filter by")
    parser.add_argument("--section_types", type=str, nargs="*",
    ...
    if args.query_type == "company_filings":
        ...
        asyncio.run(test_company_filings(
            ticker=args.ticker,
        ...
        asyncio.run(test_filing_sections(
        ...
        asyncio.run(test_related_companies(
            ticker=args.ticker,
            limit=args.limit
        ))
