...
def main():
    ...
    parser.add_argument("--metrics", type=str, nargs="*",
                        help="List of metrics to query")
    parser.add_argument("--metric", type=str,
                        help="Single metric for time series query")
    parser.add_argument("--start_date", type=str,
                        help="Start date for query (YYYY-MM-DD)")
    parser.add_argument("--end_date", type=str,
                        help="End date for query (YYYY-MM-DD)")
    parser.add_argument("--filing_type", type=str,
                        help="Filing type to filter by")
    parser.add_argument("--category", type=str,
                        help="Metric category to filter by")
    ...
    if args.query_type == "financial_facts":
        ...
        asyncio.run(test_financial_facts(
            ticker=args.ticker,
