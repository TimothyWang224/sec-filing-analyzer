...
def launch_duckdb_ui(db_path: str = None):
    ...
    try:
        ...
        if db_path is None:
            ...
            # Check if the improved database exists and use it instead
            improved_db_path = "data/db_backup/improved_financial_data.duckdb"
            if os.path.exists(improved_db_path):
                db_path = improved_db_path
