...
class Capability(ABC):
    ...
    async def process_prompt(self, agent: Any, context: Dict[str, Any], 
                           prompt: str) -> str:
        """Process the prompt before it's sent to the LLM."""
        return prompt
    
    async def process_response(self, agent: Any, context: Dict[str, Any], 
                             response: str) -> str:
        """Process the response from the LLM."""
        return response
    
    async def process_action(self, agent: Any, context: Dict[str, Any], 
                           action: Dict[str, Any]) -> Dict[str, Any]:
        """Process an action before it's executed."""
        return action
    
    async def process_result(self, agent: Any, context: Dict[str, Any],
                           response: str, action: Dict[str, Any],
                           result: Any) -> Any:
        """Process the result of an action."""
        return result
    
    async def process_new_memories(self, agent: Any, context: Dict[str, Any],
                                 response: str, result: Any,
                                 memories: list) -> list:
    ...
    async def should_terminate(self, agent: Any, context: Dict[str, Any],
                             response: str) -> bool:
