...
INSERT OR IGNORE INTO xbrl_tag_mappings (xbrl_tag, metric_id, taxonomy) VALUES
('Revenues', 1, 'us-gaap'),
('RevenueFromContractWithCustomerExcludingAssessedTax', 1, 'us-gaap'),
('SalesRevenueNet', 1, 'us-gaap'),
('CostOfRevenue', 2, 'us-gaap'),
('CostOfGoodsAndServicesSold', 2, 'us-gaap'),
('GrossProfit', 3, 'us-gaap'),
('OperatingExpenses', 4, 'us-gaap'),
('OperatingIncomeLoss', 5, 'us-gaap'),
('NetIncomeLoss', 6, 'us-gaap'),
('EarningsPerShareBasic', 7, 'us-gaap'),
('EarningsPerShareDiluted', 8, 'us-gaap'),
('CashAndCashEquivalentsAtCarryingValue', 101, 'us-gaap'),
('ShortTermInvestments', 102, 'us-gaap'),
('AccountsReceivableNetCurrent', 103, 'us-gaap'),
('InventoryNet', 104, 'us-gaap'),
('AssetsCurrent', 105, 'us-gaap'),
('PropertyPlantAndEquipmentNet', 106, 'us-gaap'),
('Goodwill', 107, 'us-gaap'),
('IntangibleAssetsNetExcludingGoodwill', 108, 'us-gaap'),
('Assets', 109, 'us-gaap'),
('AccountsPayableCurrent', 110, 'us-gaap'),
('ShortTermDebt', 111, 'us-gaap'),
('LiabilitiesCurrent', 112, 'us-gaap'),
('LongTermDebt', 113, 'us-gaap'),
('Liabilities', 114, 'us-gaap'),
('StockholdersEquity', 115, 'us-gaap'),
('NetCashProvidedByUsedInOperatingActivities', 201, 'us-gaap'),
('PaymentsToAcquirePropertyPlantAndEquipment', 202, 'us-gaap'),
('NetCashProvidedByUsedInInvestingActivities', 204, 'us-gaap'),
('NetCashProvidedByUsedInFinancingActivities', 205, 'us-gaap'),
('CashAndCashEquivalentsPeriodIncreaseDecrease', 206, 'us-gaap');
