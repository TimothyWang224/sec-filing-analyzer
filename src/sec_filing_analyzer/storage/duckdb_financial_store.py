"""
DuckDB Financial Store Module

This module provides a simple interface to store and query financial data
...
class DuckDBFinancialStore:
    """
    A simple interface to store and query financial data using DuckDB.
    """
    
    def __init__(self, db_path: Optional[str] = None):
        """Initialize the DuckDB financial store.
        ...
        logger.info(f"Initialized DuckDB financial store at {self.db_path}")
    ...
    def store_company(self, ticker: str, name: Optional[str] = None, 
                     cik: Optional[str] = None, **kwargs) -> bool:
    ...
    def store_filing(self, filing_id: str, ticker: str, 
                    accession_number: str, **kwargs) -> bool:
        ...
        try:
            ...
            # Add additional attributes
            for key, value in kwargs.items():
                if key in ["filing_type", "filing_date", "fiscal_year", 
                          "fiscal_quarter", "fiscal_period_end_date", 
                          "document_url", "has_xbrl"]:
                    data[key] = value
    ...
    def store_time_series_metrics(self, ticker: str, filing_id: str, 
    ...
    def store_financial_ratios(self, ticker: str, filing_id: str,
                              fiscal_year: int, fiscal_quarter: int,
    ...
    def store_financial_data(self, data: Dict[str, Any]) -> bool:
        ...
        try:
            if "error" in data:
                logger.warning(f"Skipping financial data with error: {data['error']}")
                return False
    ...
    def get_financial_ratios(self, ticker: str, ratios: Optional[List[str]] = None,
                            start_year: Optional[int] = None, 
                            end_year: Optional[int] = None,
                            quarterly: bool = False) -> pd.DataFrame:
