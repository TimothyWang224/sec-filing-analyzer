...
class FinancialDataProcessor:
    ...
    def __init__(self, xbrl_cache_dir: Optional[str] = None, 
...
def process_filing_financials(filing_id: str, filing_metadata: Dict[str, Any],
                             processor: Optional[FinancialDataProcessor] = None) -> bool:
