...
def launch_duckdb_ui(db_path, port=4213, listen='0.0.0.0'):
    """
...
def main():
    ...
    parser.add_argument("--db", default="data/db_backup/improved_financial_data.duckdb", help="Path to the DuckDB database file")
    parser.add_argument("--port", type=int, default=4213, help="Port to use for the UI server")
    parser.add_argument("--listen", default="0.0.0.0", help="Interface to listen on")
