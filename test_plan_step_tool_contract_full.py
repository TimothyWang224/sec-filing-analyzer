...
from src.contracts import PlanStep, Plan, ToolInput, FinancialFactsParams
...
async def test_plan_step_tool_contract():
    ...
    try:
        ...
        validate_call("sec_financial_data", "financial_facts", {
            "ticker": "AAPL",
            "metrics": ["Revenue"],
            "start_date": "2022-01-01",
            "end_date": "2022-12-31"
    ...
    try:
        ...
        validate_call("sec_financial_data", "invalid_query_type", {
            "ticker": "AAPL"
        })
        print("❌ Validation passed (should have failed)")
